...
define(["jquery","d3", "colorbrewer"],
    ...
    /**
     * constructor checks the instance if null then
     * throw an error and registers the html element
    ...
    function StringOperations(){
        ...
        if(instance !== null){
            throw new Error("Cannot instantiate more than one StringOperations, use StringOperations.getInstance()");
        }
     ...
     * @returns {*}
     */
    StringOperations.getInstance = function(){
    ...
    /**
     * This function load the instance with the required data
     * @param _data
     * @param _col
     * @param _regex
    ...
    return StringOperations.getInstance();
});